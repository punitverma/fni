...
public function sendSMS($mobile,$message){
  ...
  $this->Sms->save($sms);
    ...
    $xml_data ='<?xml version="1.0"?><parent><child><user>fni2020</user><key>aa826ab535XX</key><mobile>'.$mobile.'</mobile><message>'. $message .'</message><accusage>1</accusage><senderid>INFOTP</senderid></child></parent>';
