...
class PayoutController extends AppController
{
    ...
    public function index()
    {
        ...
        if($u->role_id==5){
            $this->paginate['conditions'] = ['member_id'=>$u->username,'payoutdt_id <>'=>0];
            
        }
        else{
            
            $this->paginate['conditions'] = ['payoutdt_id <>'=>0];
    ...
    public function sponsor($p_id,$mem_id)
    {
        ...
        $this->paginate['conditions'] = ['payoutdt_id'=>$p_id,'Payout.sponsor'=>$mem_id];
