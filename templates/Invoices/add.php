    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-6">
          ...
          <button id='btn_offer'  class="m-1 col-2" <?= $invoice->trtype=='D' ? '' :'disabled' ?>>
         GET OFFERS
          </button>
          <select id="select_offer"  class="m-1 col-4" > <option>--SELECT OFFER--</option> </select>
          

          <button id='btn_save' type="submit" class="m-1" <?= $invoice->trtype=='D' ? '' :'disabled' ?>>
            ...
            <tbody>
              ...
              ?>
                ...
                <tr>
                  ...
                  <td><?= $rec->igst_a ?></td>
                  <td><?= $rec->amount ?></td>
                  <td><button type="button" class="" id="btn_del" onClick="del(this,<?= $rec->id ?>)"> <span class="fas fa-2x fa-minus-circle"></span></button></td>
                </tr>
              <?php } ?>
...
//      $("#addl").hide();
      ...
      $('#toid').bind('change blur', function(e) {
       ...
       // alert(id);
        ...
        $.ajax({
          type: 'get',
          url: targeturl + "/" + id + "/<?= $type ?>/<?= $invoice->id ?>",
          dataType: 'json',
    ...
    $invoice->id,
      ...
      $("#frm").submit(function(event) {
        ...
        var targeturl = '/invoicedetails/add';
        $.ajax({
          type: 'post',
          url: targeturl,
          dataType: 'json',
      ...
      function AddRow(data) {
        ...
        //Add Button cell.
        cell = $(row.insertCell(-1));
        var btnRemove = '<button type="button" class="" id="btn_del" onClick="del(this,' + data.id + ')"> <span class="fas fa-2x fa-minus-circle"></span></button>';
