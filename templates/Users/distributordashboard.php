          ...
          <h1 class="h3 mb-0 text-gray-800">Dashboard <span class="text-xs">Last Update on <?= $dash->tm->i18nFormat('dd-MM-yyyy hh:mm:ss');
 ?></span></h1>
    <!--
                    ...
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          ...
                          <div class="text-xs mb-0 mr-3 font-weight-bold text-gray-800">WEEKLY SELF % LEVEL : <?= $data->self_week_points  < 301 ? '15' : ($data->self_week_points<1001 ? '20' : '25') ?> %  </div>
                          <div class="text-xs mb-0 mr-3 font-weight-bold text-gray-800">TOTAL SELF BV : <?= $data->self_total_points ?>  </div>
                          <div class="text-xs mb-0 mr-3 font-weight-bold text-gray-800">WEEKLY LEFT BV : <?= $dash->left_bv ?>  </div>
                          <div class="text-xs mb-0 mr-3 font-weight-bold text-gray-800">WEEKLY RIGHT BV : <?= $dash->right_bv ?>  </div>
                          <div class="text-xs mb-0 mr-3 font-weight-bold text-gray-800">TOTAL LEFT BV : <?= $dash->left_total ?>  </div>
                          <div class="text-xs mb-0 mr-3 font-weight-bold text-gray-800">TOTAK RIGHT BV : <?= $dash->right_total ?>  </div>
