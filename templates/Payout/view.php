...
<div class="view border content">
    ...
    <div class="row border">
        ...
        <div class="row border">
            ...
            <div class="row border">
            <?= $this->Number->format($payout->self_income) ?>
                        </div>
            
            <div class="row border">
            <?= $this->Number->format($payout->amount) ?>
                        </div>
            <div class="row border">
            <?= $this->Number->format($payout->sponsor_income) ?>
            </div>
    ...
    <div class="col-2">
        ...
        <div class="col-4 border">
            <div class="row border">
            <?= $this->Number->format($payout->tds) ?>
            </div>
            <div class="row border">
            <?= $this->Number->format($payout->sur) ?>
            </div>
            <div class="row">
            </div>
            <div class="row border">
            <?= $this->Number->format($payout->net_pay) ?>
            </div>
